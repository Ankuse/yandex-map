...
Class classes_lib extends CModule{
	var	$MODULE_ID = 'classes.lib';
	var $MODULE_VERSION;
	...
	function __construct(){
		...
		$this->MODULE_NAME = Loc::getMessage("CLASSES_LIB_MODULE_NAME");
		$this->MODULE_DESCRIPTION = Loc::getMessage("CLASSES_LIB_MODULE_DESC");

		$this->PARTNER_NAME = getMessage("CLASSES_LIB_PARTNER_NAME");
		$this->PARTNER_URI = getMessage("CLASSES_LIB_PARTNER_URI");
	...
	function DoInstall(){
		...
		if ($this->isVersionD7()){
			...
			$APPLICATION->ThrowException(Loc::getMessage("CLASSES_LIB_INSTALL_ERROR_VERSION"));
		}

		$APPLICATION->IncludeAdminFile(Loc::getMessage("CLASSES_LIB_INSTALL"), $this->GetPath()."/install/step.php");
	}
	...
	function DoUninstall(){
		...
		$APPLICATION->IncludeAdminFile(Loc::getMessage("CLASSES_LIB_UNINSTALL"), $this->GetPath()."/install/unstep.php");
	}
}
?>